            ...
            <Row>
               <Col lg='6'>
                  <div className="hero__content">
                     ...
                     <p>
                        Find Travel Buddies on EscapadeEra - the best Travel Buddy
                  Website out there. Every trip is organized by verified &
                  passionate travelers just like you. Find a travel adventure
         ...
         <Container>
            <Row>
               <Col lg='12' className='mb-5'>
                  ...
                  <h2 className='featured__tour-title'>Hodophiles</h2>
               </Col>
               <FeaturedTourList />
            </Row>
         </Container>
